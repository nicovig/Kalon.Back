...
namespace Kalon.Back.Migrations
{
    ...
    [Migration("20260612120417_AddPasswordResetTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kalon.Back.Models.GeneratedDocument", b =>
                {
                    ...
                    b.Property<int>("SnapshotDonationCount")
                        .HasColumnType("integer");

                    b.Property<DateTime>("SnapshotDonationDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("SnapshotDonationToDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Kalon.Back.Models.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kalon.Back.Models.QuotaUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "QuotaType", "Period")
                        .IsUnique();
